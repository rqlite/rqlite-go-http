...
_rqlite-go-http_ is a "thin" Go-based client for [rqlite](https://rqlite.io) that communicates directly with the rqlite [HTTP API](https://rqlite.io/docs/api/) employing minimal abstraction. This client is useful on its own or as a foundation for higher-level libraries.
